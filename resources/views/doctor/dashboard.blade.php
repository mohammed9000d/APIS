                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.html"
                                                           class="avatar avatar-sm mr-2"><img
                                                                class="avatar-img rounded-circle"
                                                                src="{{asset('doccure/assets/img/patients/patient2.jpg')}}"
                                                                alt="User Image"></a>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.html"
                                                           class="avatar avatar-sm mr-2"><img
                                                                class="avatar-img rounded-circle"
                                                                src="{{asset('doccure/assets/img/patients/patient3.jpg')}}"
                                                                alt="User Image"></a>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.html"
                                                           class="avatar avatar-sm mr-2"><img
                                                                class="avatar-img rounded-circle"
                                                                src="{{asset('doccure/assets/img/patients/patient4.jpg')}}"
                                                                alt="User Image"></a>
                                                ...
                                                <td>
                                                    <h2 class="table-avatar">
                                                        <a href="patient-profile.html"
                                                           class="avatar avatar-sm mr-2"><img
                                                                class="avatar-img rounded-circle"
                                                                src="{{asset('doccure/assets/img/patients/patient5.jpg')}}"
                                                                alt="User Image"></a>
