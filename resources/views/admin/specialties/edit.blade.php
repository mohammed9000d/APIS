                        ...
                        <div class="card-body">
                            ...
                            @method('put')
                                ...
                                <div class="form-group">
                                    ...
                                    <input name = "title_en" value = "{{ $specialty->title_en}}" type="text" class="form-control">
                                </div>

                                <div class="form-group">
                                    <label>Description en</label>
                                    <input name = "description_en" value = "{{ $specialty->description_en}}" type="text" class="form-control">
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="status-toggle">
                                        <input  name = "status" value = "{{ $specialty->status}}" type="checkbox" id="status_1" class="check" checked="">
