                ...
                <div class="card-body">
                    ...
                    <form action="{{route('patients.update',[$patient->id])}}"method="post"
                        ...
                        <div class="form-group">
                            ...
                            <input name="first_name" value="{{$patient->first_name }}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Last Name</label>
                            <input name="last_name" value="{{$patient->last_name  }}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Email</label>
                            <input name="email" value="{{$patient->email  }}" type="email" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Mobile</label>
                            <input name="mobile" value="{{$patient->mobile }}" type="tel" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Date</label>
                            <input name = "birth_date" value="{{$patient->birth_date }}" type="date" id="date" class="form-control">
                        </div>
