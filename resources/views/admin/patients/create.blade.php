        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('patients.store') }}" method="POST" id="create_patients_form"
                    enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label>Date</label>
                            <input name = "birth_date" value="{{ old('birth_date') }}" type="date" id="date" class="form-control">
                        </div>
