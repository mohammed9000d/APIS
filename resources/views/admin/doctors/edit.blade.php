                ...
                <div class="card-body">
                    ...
                    @method('put')
                        ...
                        <div class="form-group">
                            ...
                            <input name="first_name" value="{{$doctor->first_name}}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Last Name</label>
                            <input name="last_name" value="{{$doctor->last_name}}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Email</label>
                            <input name="email" value="{{$doctor->email}}" type="email" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Mobile</label>
                            <input name="mobile" value="{{$doctor->mobile}}" type="tel" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Birth Date</label>
                            <input name="birth_date" value="{{$doctor->birth_date}}" type="date" class="form-control">
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input name="hour_price" value="{{$doctor->hour_price}}" type="text" class="form-control">
                        </div>
                        </div>

                        <div class="form-group">
                            <label>Facebook Url</label>
                            <input name="facebook_url" value="{{$doctor->facebook_url}}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Twitter Url</label>
                            <input name="twitter_url" value="{{$doctor->twitter_url}}" type="text" class="form-control">
                        </div>

                        <div class="form-group">
                            <label>Linked_in Url</label>
                            <input name="linked_in_url" value="{{$doctor->linked_in_url}}" type="text" class="form-control">
                        </div>

                        <div class="form-group row">
                            <label class="col-lg-3 col-form-label">About</label>
                            <div class="col-lg-9">
                                <textarea rows="4" name="about" value="{{$doctor->about}}" cols="5" class="form-control" placeholder="Enter message"></textarea>
                            </div>
                        </div>
